...
from cognition_lattice import agent_core
from cognition_lattice.agent_runtime_manager import AgentRuntimeManager
...
async def test_run_with_retry_exhaustion(tmp_path, monkeypatch):
    agents_dir = Path('src') / 'cognition_lattice' / 'agents'
